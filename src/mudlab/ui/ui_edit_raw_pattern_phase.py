...
#if QT_CONFIG(tooltip)
        self.button_import_pattern.setToolTip(QCoreApplication.translate("EditRawPatternPhaseWidget", u"Import the measured pattern from an XRD data file (.xy, .txt, .csv, .dat).", None))
#endif // QT_CONFIG(tooltip)
