...
#if QT_CONFIG(tooltip)
        self.btn_add_cif.setToolTip(QCoreApplication.translate("NonclayDialog", u"Build a reference from a crystal structure - a CIF with explicit symmetry ops (COD/AMCSD) or a BGMN .str - using this specimen's goniometer.", None))
#endif // QT_CONFIG(tooltip)
        self.btn_add_cif.setText(QCoreApplication.translate("NonclayDialog", u"Add structure\u2026", None))
#if QT_CONFIG(tooltip)
